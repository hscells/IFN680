...
class Quantumgame(Quantumboard,game.Game):
    ...
    def is_terminal(self):
        ...
        '''
        return self.cache_legal_moves is not None and len(self.cache_legal_moves) > 0  # INSERT YOUR CODE HERE  : just the rest of the line
