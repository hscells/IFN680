...
class Random_player(Player):
    ...
    def play(self, opp_move):
        ...
        m = random.choice(self.game.legal_moves())
        self.game.do_move(m)
        return m    
...
def play(game, player1, player2, verbose = 1):
    ...
    while not game.is_terminal():
        ...
        legal_move_hist[game.turn].append(len(game.legal_moves()))
        game.do_move(move)
        last_move = move
#        print('debug end while game turn and move is >> ', game.turn, move )
    ...
    if verbose:
        ...
        game.print_move(last_move)
        game.display()
        print('Mover is ', game.turn)

    return last_move, legal_move_hist
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
